...
file = "install_object_1_schema_first_0_FUNCTION.sql"
checkFile(target_service + file, verify_service + file, 0)

file = "install_object_1_schema_first_1_TRIGGER.sql"
checkFile(target_service + file, verify_service + file, 0)

file = "install_object_3_schema_third_0_FUNCTION.sql"
checkFile(target_service + file, verify_service + file, 0)

file = "install_object_3_schema_third_1_TRIGGER.sql"
checkFile(target_service + file, verify_service + file, 0)

file = "install_script_2_schema_second_AFTER_1.sql"
checkFile(target_service + file, verify_service + file, 0)

file = "install_script_2_schema_second_BEFORE_0.sql"
checkFile(target_service + file, verify_service + file, 0)
